    ...
    <tbody>
        <?php while($row = mysqli_fetch_assoc($result)){
            ...
            <tr>
                ...
                <td><?= $row['name'] ?></td>
                <td>
                    <a href="<?= 'deleteRow.php?id='.$row['id'].'&name=obligation'?>" class="btn" style="background: #9e2e2b;" >
                        <i class="fa fa-trash"></i>
                    </a>
                </td>
                <td>
                    <a href="<?='indexAdmin.php?name=viewObligation&obligationId='.$row['id']?>" class="btn">Detaljno</a>
                </td>
            </tr>
        <?php
        }
