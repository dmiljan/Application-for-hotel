    ...
    and isset($_REQUEST['priceWeekend']) and isset($_REQUEST['priceWeekendWithBreakfast']))
{
    ...
    $queryPrice = "INSERT INTO `price`(`id`, `price`, `price_with_breakfast`, `price_weekend`, `price_weekend_with_breakfast`) 
                   VALUES ('$new_id_price', '$price', '$priceWithBreakfast', '$priceWeekend', '$priceWeekendWithBreakfast')";
    $queryAccommodation = "INSERT INTO `accommodation`(`id`, `name`, `capacity`, `accommodation_type_id`, `price_id`) 
                           VALUES ('$new_id_accommodation', '$nameAccommodation', '$capacity', '$typeAccommodation', '$new_id_price')";
