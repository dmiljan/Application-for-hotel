...
$query = "SELECT guest.id AS guest_id, rezervation.id AS rezervation_id, accommodation.id AS accommodation_id, user.id AS user_id,
    ...
    JOIN guest ON rezervation.guest_id=guest.id JOIN user ON rezervation.user_id=user.id JOIN accommodation ON rezervation.accommodation_id=accommodation.id";
